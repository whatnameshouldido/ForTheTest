...
public class AccountServiceTests {
    ...
    public void moneyIn() {
        ...
        boolean result = accountService.moneyIn("222-222", 70000);
    ...
    public void moneyOut() {
        ...
        boolean result = accountService.moneyOut("111-111", 20000);
        assertThat(result).isEqualTo(true);
        ...
        boolean result2 = accountService.moneyOut("111-111", 50000);
