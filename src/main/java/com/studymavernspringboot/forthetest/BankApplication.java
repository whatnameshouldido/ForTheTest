//새롭게 추가한 기능 : 종료하기 전에 한번 더 물어보기 + 계좌번호 같은 게 만들어졌는데 중복된 계좌번호는 못 만들게 변경

package com.studymavernspringboot.forthetest;
...
public class BankApplication {
    ...
    public void pushMoney(Scanner scanner) throws Exception {
        ...
        if (this.accountService.moneyIn(result.getAcNum(), result.getMyMoney())) {
    ...
    public void pullMoney(Scanner scanner) throws Exception {
        ...
        if (this.accountService.moneyOut(result.getAcNum(), result.getMyMoney())) {
